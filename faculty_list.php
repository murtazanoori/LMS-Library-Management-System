...
<div class="col-12 d-flex align-items-center justify-content-between">
    ...
    <form class="form-horizontal" action="add_faculty_insert_code.php" method="post" name="upload_excel"   
...
<div class="row col-12 d-flex align-items-center justify-content-between" style="margin-top:20px;">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Recent Manage Faculty</h4><br>
                ...
                if (isset($_SESSION['response'])) { ?>
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" placeholder="Search id here.." name="faculty_id" style="height:40px;">
                                    </div>
                                </div>
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder=" Search by name here.." name="faculty_name" style="height:40px;">
                                    </div>
                                </div>
                    ...
                    <?php
                        if(isset($_POST['search'])){    
                            ...
                            $q = 'SELECT * FROM `faculty` WHERE faculty.faculty_id = "'.$faculty_id.'" OR faculty.faculty_name ="'.$faculty_name.'"';
                    ...
                    <table class="table table-hover table-centered mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row" style="color:blue;"><?php echo $res['faculty_id'];?></th>
                                <td>
                                ...
                                <td>
                                    <div class="btn-group dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="edit_faculty?faculty_id=<?php echo $res['faculty_id'];?>"><i class="mdi mdi-pencil mr-1 text-muted"></i>Edit</a>
                                            <?php if($_SESSION['role']==0){?>
                                            <input type="hidden" name="" class="delete_id_value" value="<?php echo $res['faculty_id'];?>">
                    ...
                    <div class="mt-4">
                        <div class="alert alert-warning alert-dismissible text-center">
                            <b class="">Search & Manage Data To Show Record..!</b>
                        </div>
                    </div>
                    <?php
                        }
        ...
        $('.delete_btn_ajax').click(function (e){
            ...
            swal({
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "POST",
                        url:  "add_faculty_insert_code.php",
                        data: {
                            "delete_btn_set": 1,
                            "delete_id": deleteid,
                        },
