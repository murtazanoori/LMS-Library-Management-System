                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="d-block p-4" style="border-radius:6px; background-color:#f9fbfd">
                            ...
                            <!-- Modal body -->
                            <form class="form-horizontal" action="add_cd_of_book" method="POST" name="upload_excel" enctype="multipart/form-data">
                                <div class="row">
...
<div class="row col-12 d-flex align-items-center justify-content-between" style="margin-top:20px;">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Recent Manage CD</h4><br>
                <div class="wrapper">
                <a href="cd_table" class="btn btn-link btn-sm font-weight-bold">
                <i class="icon-folder-alt"></i>Show All Cd File</a>

                <form class="form-horizontal" action="add_cd_of_book" method="post" name="upload_excel"   
                ...
                if (isset($_SESSION['response'])) { ?>
                    ...
                    <div class="col-md-12">
                        <form action="manage_cd" method="post">
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" placeholder="Search by id.." name="cd_id" style="height:40px;">
                                    </div>
                                </div>
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Search by title.." name="cd_title" style="height:40px;">
                                    </div>
                                </div>
                                <div class="col-md-6 form-group">
                    ...
                    <?php
                        if(isset($_POST['search'])){  
                                ...
                                WHERE cd.cd_id LIKE "'.$cd_id.'" OR cd.cd_title LIKE "'.$cd_title.'" OR cd.Author LIKE "'.$Author.'" OR cd.created_at LIKE "'.$created_at.'"';
                              $query = mysqli_query($con,$q);
                            if (mysqli_num_rows($query) > 0) {     
                    ?>
                    
                    <table class="table table-responsive table-hover table-centered mb-0" id="order-listing">
                    <form action="barcode_page_cd" method="POST">
                                ...
                                <td>
                                    <div class="btn-group dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="edit_cd?cd_id=<?php echo $res['cd_id'];?>"><i class="mdi mdi-pencil mr-1 text-muted"></i>Edit</a>
                                            <?php if($_SESSION['role'] == 0){?>
                                            <input type="hidden" name="" class="delete_id_value" value="<?php echo $res['cd_id'];?>">
