                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="d-block p-4" style="border-radius:6px; background-color:#f9fbfd">
                            ...
                            <!-- Modal body -->
                            <form class="form-horizontal" action="add_monograph" method="POST" name="upload_excel" enctype="multipart/form-data">
                                <div class="row">
...
<div class="row col-12 d-flex align-items-center justify-content-between" style="margin-top:20px;">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Recent Manage Monograph</h4><br>
                <div class="wrapper">
                <a href="monograph_table" class="btn btn-link btn-sm font-weight-bold">
                <i class=" icon-notebook"></i>Show All Monograph</a>

                <form class="form-horizontal" action="add_monograph" method="post" name="upload_excel"   
...
<div class="form-group" style="float:right; margin-top:-18px;">
          <button name="Export" class="bti" value="Export To Excel"><i class="icon-share-alt"></i> Export To CSV</button>
                ...
                if (isset($_SESSION['response'])) { ?>
                    ...
                    <div class="col-md-12">
                        <form action="manage_monograph" method="post">
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" placeholder="Search by id.." name="mo_id" style="height:40px;">
                                    </div>
                                </div>
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Search by title.." name="m_title" style="height:40px;">
                                    </div>
                                </div>
                                <div class="col-md-6 form-group">
                    ...
                    <?php
                        if(isset($_POST['search'])){  
                                ...
                                $q = 'SELECT * FROM `monograph` JOIN book_case ON monograph.b_c_id = book_case.b_c_id JOIN faculty ON monograph.faculty_id = faculty.faculty_id JOIN department ON 
                            monograph.department_id = department.department_id WHERE monograph.mo_id LIKE "'.$mo_id.'" OR monograph.m_title LIKE "'.$m_title.'" OR monograph.Author LIKE "'.$Author.'" OR monograph.created_at LIKE "'.$created_at.'" OR monograph.department_id LIKE "'.$department.'"';
                              $query = mysqli_query($con,$q);
                            if (mysqli_num_rows($query) > 0) {     
                    ?>
                    
                    <table class="table table-responsive table-hover table-centered mb-0" id="order-listing">
                    <form action="barcode_page_monograph" method="POST">
                        ...
                        <tbody>
                            ...
                            <th>
                                                <div class="checkbox">             
                                            <input type="checkbox" name="barcodeText[]" value="<?php echo $res['mo_id'];?>" class="checkitem">
                                            </div>                           
                                </th>
                                <th scope="row">
                                ...
                                <td>
                                    <?php echo $res['guide_teacher'];?>
                                </td>

                                <td>
                                    <?php echo $res['graduation_year'];?>
                                </td>
                                <td>
                                    <?php echo $res['score'];?>
                                </td>
                                ...
                                <td>
                                    <div class="btn-group dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="edit_monograph?mo_id=<?php echo $res['mo_id'];?>"><i class="mdi mdi-pencil mr-1 text-muted"></i>Edit</a>
                                            <?php if($_SESSION['role'] == 0){?>
                                            <input type="hidden" name="" class="delete_id_value" value="<?php echo $res['mo_id'];?>">
