...
<div class="card col-12" style="margin-top:40px;">
    ...
    <div class="card-body">
        ...
        <?php
            ...
            $hs_id = $_GET['hs_id'];
            $q = "SELECT * FROM `history_book` WHERE hs_id = '$hs_id'";
            ...
            //echo $row['book_id'];
        ?>
        <form action="add_history_book" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="hs_id" value="<?php echo $row['hs_id'];?>" class="form-control" placeholder=" Loading..." style="height:40px;">
            <div class="row">
                ...
                <div class="col-md-6 form-group mb-3">
                    ...
                    <div class="input-group" style="margin-top: 25px;">
                        <button type="submit" class="btn btn-warning col-12" name="hs_update"><span class="icon-note"></span> Edit</button>
                    </div>
