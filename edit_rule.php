...
<div class="card col-12" style="margin-top:40px;">
    ...
    <div class="card-body">
        ...
        <?php
            ...
            $r_id = $_GET['r_id'];
            $q = "SELECT * FROM `rule_book` WHERE r_id = '$r_id'";
            ...
            //echo $row['book_id'];
        ?>
        <form action="rule_code" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="r_id" value="<?php echo $row['r_id'];?>" class="form-control" placeholder=" Loading..." style="height:40px;">
            <div class="row">
                ...
                <div class="col-md-6 form-group mb-3">
                    ...
                    <div class="input-group" style="margin-top: 25px;">
                        <button type="submit" class="btn btn-warning col-12" name="r_update"><span class="icon-note"></span> Edit</button>
                    </div>
