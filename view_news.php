...
?>
    ...
    <p class="menu-icon icon-loop" style="font-size:1.2rem;"> View All News</p>
           ...
           <div class="row mt-3 ml-1 container" >
            ...
            <div class="col-12 col-md-12 grid-margin stretch-card">
              <div class="card col-xl">
				   <a href="det_news?id=<?php echo $res['id'];?>" class="text-decoration-none"> 
                  ...
                  <div class="d-flex flex-row">
                    <?php
                      if ($res['news_img'] =='') {
                        # code...
                    ?>
                    <img src="images/responsive.png" class="img-lg rounded" alt="profile image" />
                    <?php
                      }else {
                        # code...
                    ?>
                    <img src="images/<?php echo $res['news_img'];?>" class="img-lg rounded" alt="profile image" />
                    <?php }?>
                    <div class="ml-3">
                      <h6><?php echo $res['name'];?></h6>
                      <p class="text-muted"><?php echo $res['dis'];?></p>
