                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="d-block p-4" style="border-radius:6px; background-color:#f9fbfd">
                            ...
                            <!-- Modal body -->
                            <form class="form-horizontal" action="history_code" method="POST" name="upload_excel" enctype="multipart/form-data">
                                <div class="row">
...
<div class="row col-12 d-flex align-items-center justify-content-between" style="margin-top:20px;">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Recent Manage History Book</h4><br>
                <div class="wrapper">
                <a href="history_table" class="btn btn-link btn-sm font-weight-bold">
                <i class="mdi mdi-file-document-outline"></i>Show All History Book</a>

                <form class="form-horizontal" action="add_history_book" method="post" name="upload_excel"   
                ...
                if (isset($_SESSION['response'])) { ?>
                    ...
                    <div class="col-md-12">
                        <form action="manage_history" method="post">
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" placeholder="Search by id.." name="hs_id" style="height:40px;">
                                    </div>
                                </div>
                                <div class="col-md-6 form-group">
                    ...
                    <?php
                        if(isset($_POST['search'])){  
                                ...
                                $q = 'SELECT * FROM `history_book` JOIN book_case ON history_book.b_c_id = book_case.b_c_id
                                WHERE history_book.hs_id LIKE "'.$hs_id.'" OR history_book.book_title LIKE "'.$book_title.'" OR history_book.Author LIKE "'.$Author.'" OR history_book.created_at LIKE "'.$created_at.'"';
                              $query = mysqli_query($con,$q);
                            if (mysqli_num_rows($query) > 0) {     
                    ?>
                    
                    <table class="table table-responsive table-hover table-centered mb-0" id="order-listing">
                    <form action="barcode_page_history" method="POST">
                        ...
                        <tbody>
                            ...
                            <th>
                                                <div class="checkbox">             
                                            <input type="checkbox" name="barcodeText[]" value="<?php echo $res['hs_id'];?>" class="checkitem">
                                            </div>                           
                                </th>
                                ...
                                <td>
                                    <div class="btn-group dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="edit_history?hs_id=<?php echo $res['hs_id'];?>"><i class="mdi mdi-pencil mr-1 text-muted"></i>Edit</a>
                                            <?php if($_SESSION['role'] == 0){?>
                                            <input type="hidden" name="" class="delete_id_value" value="<?php echo $res['hs_id'];?>">
