...
<div class="row col-12 d-flex align-items-center justify-content-between" style="margin-top:20px;">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Recent Manage Teacher</h4><br>
                ...
                if (isset($_SESSION['response'])) { ?>
                    ...
                    <div class="col-md-12">
                        <form action="manage_teacher" method="post">
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" placeholder="Search id" name="teacher_id" style="height:40px;">
                                    </div>
                                </div>
                                <div class="col-md-6 form-group">
                    ...
                    <?php
                        if(isset($_POST['search'])){ 
                            ...
                            $q = 'SELECT * FROM `teacher` JOIN department ON teacher.department_id = department.department_id WHERE teacher.teacher_id = "'.$id.'" OR teacher.name ="'.$fname.'" OR teacher.lastname = "'.$last_name.'" OR teacher.department_id = "'.$department.'"';
                    ...
                    <table class="table table-hover table-centered mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row"><?php echo $res['teacher_id'];?></th>
                                <td>
                                    <?php echo $res['name'];?>
                                </td>
                                ...
                                <td>
                                    <div class="btn-group dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="edit_teacher?teacher_id=<?php echo $res['teacher_id'];?>"><i class="mdi mdi-pencil mr-1 text-muted"></i>Edit</a>
                                            <?php if($_SESSION['role'] == 0){?>
                                            <input type="hidden" name="" class="delete_id_value" value="<?php echo $res['teacher_id'];?>">
        ...
        $('.delete_btn_ajax').click(function (e){
            ...
            swal({
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "POST",
                        url:  "enroll_teacher_insert_code.php",
                        data: {
                            "delete_btn_set": 1,
                            "delete_id": deleteid,
                        },
