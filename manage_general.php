                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="d-block p-4" style="border-radius:6px; background-color:#f9fbfd">
                            ...
                            <!-- Modal body -->
                            <form class="form-horizontal" action="add_general_book" method="POST" name="upload_excel" enctype="multipart/form-data">
                                <div class="row">
...
<div class="row col-12 d-flex align-items-center justify-content-between" style="margin-top:20px;">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Recent Manage General Book</h4><br>
                <div class="wrapper">
                <a href="general_table" class="btn btn-link btn-sm font-weight-bold">
                <i class="icon-social-dribbble"></i>Show All General Book</a>

                <form class="form-horizontal" action="general_book_code" method="post" name="upload_excel"   
                ...
                if (isset($_SESSION['response'])) { ?>
                    ...
                    <div class="col-md-12">
                        <form action="manage_general" method="post">
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <label for="validationCustomUsername">General Book ID</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" style="background-color:#eee;">#</span>
                                        </div>
                                        <input type="number" class="form-control" placeholder="Search by id.." name="general_book_id" style="height:40px;">
                                    </div>
                                </div>
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Search by title.." name="book_title" style="height:40px;">
                                    </div>
                                </div>
                                <div class="col-md-6 form-group">
                    ...
                    <?php
                        if(isset($_POST['search'])){  
                                ...
                                $q = 'SELECT * FROM `general_book` JOIN book_case ON general_book.b_c_id = book_case.b_c_id
                                WHERE general_book.general_book_id LIKE "'.$general_book_id.'" OR general_book.book_title LIKE "'.$book_title.'" OR general_book.author LIKE "'.$author.'" OR general_book.created_at LIKE "'.$created_at.'"';
                              $query = mysqli_query($con,$q);
                            if (mysqli_num_rows($query) > 0) {     
                    ?>
                    
                    <table class="table table-responsive table-hover table-centered mb-0" id="order-listing">
                    <form action="barcode_page_general" method="POST">
                        ...
                        <tbody>
                            ...
                            <th>
                                                <div class="checkbox">             
                                            <input type="checkbox" name="barcodeText[]" value="<?php echo $res['general_book_id'];?>" class="checkitem">
                                            </div>                           
                                </th>
                                <th scope="row">
                                   
                                        <?php echo $res['general_book_id'];?>
                                ...
                                <td>
                                    <div class="btn-group dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="edit_general_book?general_book_id=<?php echo $res['general_book_id'];?>"><i class="mdi mdi-pencil mr-1 text-muted"></i>Edit</a>
                                            <?php if($_SESSION['role'] == 0){?>
                                            <input type="hidden" name="" class="delete_id_value" value="<?php echo $res['general_book_id'];?>">
