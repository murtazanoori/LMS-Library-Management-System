...
<div class="col-12 d-flex align-items-center justify-content-between">
    ...
    <div class="modal-dialog modal-dialog-centered">
      ...
      <div class="d-block p-4" style="border-radius:6px; background-color:#f9fbfd">
        ...
        <!-- Modal body -->
        <form class="form-horizontal" action="add_faculty_insert_code.php" method="post" name="upload_excel" enctype="multipart/form-data">
                 <div class="row">
...
<div class="bg-white d-block p-4" style="width:100%; margin-bottom:70px; margin-top:20px; border:1px solid #eee; border-radius:6px;" id="b">
    <div class="d-block p-4" style="border-radius:6px; background-color:#f9fbfd">
    <p class="menu-icon icon-graduation" style="font-size:1.2rem;"> Faculty</p>
        ...
        <div style="margin-top:20px">
            ...
            <!-- form -->
            <form id="form" action="add_faculty_insert_code.php" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-6 form-group mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" placeholder=" Type faculty id here.." name="faculty_id" style="height:40px;">
                        </div>
                    </div>
                    <div class="col-md-6 form-group mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder=" Type faculty name here.." name="faculty_name" style="height:40px;">
...
<!-- validation -->
    ...
    <script type="text/javascript">
            ...
            $("#form").validate({
                ...
                faculty_name:{
                    required: '<span id="sp" style="color:red">** Hops! this filed is required : Enter name</span>'
                }
                },
