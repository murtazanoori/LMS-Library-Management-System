...
<div class="col-12 d-flex align-items-center justify-content-between">
    <h4 class="page-title">
        ...
        <a  href="view_journal" name="view_journal" class="col-md-12 offset-0 btn btn-warning  text-white">View All Journal</a>
...
<div class="row col-12 d-flex align-items-center justify-content-between" style="margin-top:20px;">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Recent Journal Manage</h4><br>
                ...
                if (isset($_SESSION['response'])) { ?>
                    ...
                    <div class="col-md-12">
                        <form action="journal_list" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Type title to search" name="title" style="height:40px;">
                                    </div>
                                </div>
                    ...
                    <?php
                        if(isset($_POST['search'])){
                            $title = $_POST['title'];
                            $q = 'SELECT * FROM `journal` WHERE journal.title = "'.$title.'"';
                                ...
                                <td>
                                    <div class="btn-group dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="edit_journal?j_id=<?php echo $res['j_id'];?>"><i class="mdi mdi-pencil mr-1 text-muted"></i>Edit</a>
                                            <?php if($_SESSION['role'] == 0){?>
                                            <input type="hidden" name="" class="delete_id_value" value="<?php echo $res['j_id'];?>">
