...
<div class="bg-white d-block p-4" style="width:100%; margin-bottom:70px; margin-top:20px; border:1px solid #eee; border-radius:6px;" id="b">
    ...
    <p class="menu-icon  icon-loop text-primary" style="font-size:1.2rem;"> News</p>
        ...
        <div style="margin-top:20px">
            ...
            <!-- form -->
            <form id="form" action="news_code.php" method="post" enctype="multipart/form-data">
                <div class="row">


                  <div class="col-md-12 form-group mb-3">
                        <label for="validationCustomUsername">News Name</label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text menu-icon icon-note"
                                    style="background-color:#eee;"></span>
                            </div>
                            <input type="text" class="form-control" placeholder="Type news name.."
                ...
                <div class="row">
                  ...
                  <div class="col-md-12 form-group mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Type news dis.."
                                name="dis" style="height:40px;">
                        </div>
                  </div>
                </div>
                 <div class="col-md-12 form-group mb-3">
                  ...
                  <label for="floatingTextarea2">INFO</label>
                        <textarea name="info" class="form-control" placeholder="Leave new info here" id="floatingTextarea2" style="height:200px"></textarea>
