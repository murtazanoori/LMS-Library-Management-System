                    ...
                    <?php
                        ...
                        if (mysqli_num_rows($run_query)>0) {
                            ...
                            foreach ($run_query as $row) {
                                ...
                                //echo $row['name'];
                                ?>
                                                <form action="journal_code" method="POST" enctype="multipart/form-data">
                                                    
                                                    <div class="row">
                                                    <input type="hidden" name="old_id" value="<?php echo $row['j_id']?>"/>
					                                <input type="hidden" name="old_img" value="<?php echo $row['photo'];?>"/> 
                                                            ...
                                                            <div class="col-md-12 form-group mb-3">
                                                                <label for="validationCustomUsername">Info</label>
                                                                <div class="input-group">
                                                                    <div class="input-group-prepend">
                                                                        <span class="input-group-text  menu-icon icon-calendar"
                                                                            style="background-color:#eee;"></span>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-6 form-group mb-3">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="date" name="publish_year" class="form-control" placeholder="loading.." value="<?php echo $row['publish_year'];?>" style="height:40px;" >
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6 form-group mb-3">
                                                                <label for="validationCustomUsername">Pages</label>
                                                                <div class="input-group">
                                                                    <div class="input-group-prepend">
                                                                        <span class="input-group-text  menu-icon   icon-pencil"
                                                                            style="background-color:#eee;"></span>
                                                                    </div>
                                                                    <input type="number" name="pages" class="form-control" placeholder="loading.." value="<?php echo $row['pages'];?>" style="height:40px;" >
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12 form-group mb-3">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <select class="form-control" name="avalibality" style="height:40px;">
                                                                    <option selected hidden>Select Avalibality</option>
                                                                    <option value="Avalible" <?php if($row['avalibality']=='Avalible') echo"selected=selected"; ?>>Avalible</option>
                                                                    <option value="Coming_Soon" <?php if($row['avalibality']=='Coming_Soon') echo"selected=selected"; ?> >Coming Soon</option>
                                                                    </select>
                                                                            </div>
                                                            </div>
                                                            <div class="col-md-12 form-group mb-3">
                                                                <label for="validationCustomUsername">Select Journal Image</label>
                                                                <div class="input-group">
                                                                    <div class="input-group-prepend">
                                                            ...
                                                            <div class="col-md-12 form-group mb-3">
                                                                <label for="validationCustomUsername">Journal Image</label>
                                                                <div class="input-group">
                                                                    <div class="input-group-prepend">
                                                                        <span class="input-group-text  menu-icon   icon-picture"
                                                                            style="background-color:#eee;"></span>
                                                                    </div>
                                                                    <img src="<?php echo "journal/".$row['photo'];?>" style="height:400px;height:300px;" alt="">
                                                                </div>
                                                            </div>                  
                                                    </div>
                                                    <br><br>
