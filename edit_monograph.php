...
<div class="card col-12" style="margin-top:40px;">
    ...
    <div class="card-body">
        ...
        <?php
            ...
            $mo_id = $_GET['mo_id'];
            $q = "SELECT * FROM `monograph` WHERE mo_id = '$mo_id'";
            ...
            //echo $row['book_id'];
        ?>
        <form action="add_monograph" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="mo_id" value="<?php echo $row['mo_id'];?>" class="form-control" placeholder=" Loading..." style="height:40px;">
            <div class="row">
                ...
                <div class="col-md-6 form-group mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="m_title" value="<?php echo $row['m_title'];?>" class="form-control" placeholder=" Loading..." style="height:40px;">
                    </div>
                </div>
                <div class="col-md-6 form-group mb-3">
                ...
                <div class="col-md-6 form-group mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="guide_teacher" value="<?php echo $row['guide_teacher'];?>" class="form-control" placeholder="Loading..." style="height:40px;">
                    </div>
                </div>
                ...
                <div class="col-md-6 form-group mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="date" name="graduation_year" value="<?php echo $row['graduation_year'];?>" class="form-control" placeholder="Loading..." style="height:40px;">
                    </div>
                </div>
                <div class="col-md-6 form-group mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="score" value="<?php echo $row['score'];?>" class="form-control" placeholder="Loading..." style="height:40px;">
                    </div>
                </div>
                ...
                <div class="col-md-6 form-group mb-3">
                    ...
                    <div class="input-group" style="margin-top: 25px;">
                        <button type="submit" class="btn btn-warning col-12" name="monograph_update"><span class="icon-note"></span> Edit</button>
                    </div>
